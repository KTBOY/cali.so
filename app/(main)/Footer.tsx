    ...
    <footer className="mt-32">
      <Container.Outer>
        <div className="border-t border-zinc-100 pb-16 pt-10 dark:border-zinc-700/40">
          <Container.Inner>
            <div className="mx-auto mb-8 max-w-md" style={{'display':'none'}}>
              {<Newsletter subCount={`${subs?.subCount ?? '0'}`} />}
            </div>
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row" style={{'display':'none'}}>
              {<p className="text-sm text-zinc-500/80 dark:text-zinc-400/80">
                &copy; {new Date().getFullYear()} Shu ke. 
                <PeekabooLink href="https://github.com/KTBOY">
                  GitHub
                </PeekabooLink>
              </p>}
              <Links />
