    ...
    <div className="max-w-2xl" style={{'display':'none'}}>
      ...
      >
        <SocialLink
          ...
          aria-label={t('myTwitter')}
          platform="twitter"
        />
        <SocialLink
          href="https://cali.so/youtube"
          aria-label={t('myYouTube')}
          platform="youtube"
        />
        <SocialLink
          href="https://cali.so/bilibili"
          aria-label={t('myBilibili')}
          platform="bilibili"
        />
        <SocialLink
          href="https://cali.so/github"
          aria-label={t('myGitHub')}
          platform="github"
        />
        <SocialLink
          href="https://cali.so/tg"
          aria-label={t('myTelegram')}
          platform="telegram"
        />
        <SocialLink href="/feed.xml" platform="rss" aria-label={t('rss')} />
        <SocialLink
          href="mailto:hi@cali.so"
          aria-label={t('myEmail')}
          platform="mail"
        />
      </motion.div>
    </div>
